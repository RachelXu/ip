	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			...
			<!-- // #start sidebar -->
                ...
                <s2:form action="procatalogdelete" theme="simple">
                ...
                <s2:hidden name="editId"/>
					<h3>删除栏目信息</h3>
						...
						<tr>
							<td>栏目中文名称:</td>
							<td><s2:textfield name="catalogEdit.catalogZhName"  size="10" maxlength="10"  readonly="true" /></td>
							<td>栏目英文名称:</td>
							<td><s2:textfield name="catalogEdit.catalogEnName"  size="10" maxlength="10" readonly="true" /></td>
						</tr>
						<tr>
							<td>显示顺序:</td>
							<td><s2:textfield name="catalogEdit.order"  size="3" maxlength="3"  readonly="true" /></td>
							<td>上级栏目:</td>
							<td><s2:select list="catalogEdit.firstLeveList" name="catalogEdit.superId" listKey="value" listValue="label" headerKey="" headerValue="-" disabled="true" >
