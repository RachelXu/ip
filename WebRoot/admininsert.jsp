			...
			<!-- // #start sidebar -->
        		<div id="sidebar">
        		   <ul class="sideNav">
                    	...
                    	<li><a href="preadmininsert.action" class="active" >添加管理员</a></li>
                    	</s2:if>
                    </ul>
                </div>   
                <!-- // #end sidebar -->
                ...
                <!-- main page -->
                <h2><a href="#">运维管理</a> &raquo; <a href="#" class="active">添加管理员</a></h2>
                <div id="main1" class="main">
                <p align="left"><s2:fielderror cssStyle="font-size:15px; color:red; font-weight:bold "/></p>
                <s2:form action="proadmininsert" theme="simple">
                <s2:hidden name="editId"/>
					<h3>管理员信息</h3>
                    	<table border="1">	
							<tr>
							  <td>管理员名称</td>
							  <td><s2:textfield name="admin1.username" size="10" maxlength="10" /></td>
							  <td></td>
							  <td></td>
							</tr>
							<tr>
