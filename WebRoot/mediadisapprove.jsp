			...
			<!-- // #start sidebar -->
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href="premediadisapprove.action" class="active">确认节目发布</a></li>
                    	</s2:if>
                    </ul>
                </div>    
                <!-- // #end sidebar -->
                ...
                <!-- main page -->
                <h2><a href="#">节目信息管理</a> &raquo; <a href="#" class="active">确认节目发布</a></h2>
                ...
                <s2:hidden name="editId"/>
						...
						<table>
					      ...
					      <tr>
							  <td colspan="8" align="center" ><input type="button" value="全选" onclick="checkAll();"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="取消全选" onclick="checkNone();"/>&nbsp;&nbsp;&nbsp;&nbsp;<s2:submit value="确认发布" action="promediadisapprove" /> </td>
					      </tr>
						</table>
						</s2:if>
                   </s2:form>
