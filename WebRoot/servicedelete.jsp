	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			...
			<!-- // #start sidebar -->
                ...
                <s2:form action="proservicedelete" theme="simple">
					<h3>服务套餐信息</h3>
                    	<table border="1">	
                    		<tr>
							  <td>服务套餐ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s2:textfield name="service.serviceId" size="10" maxlength="10" readonly="true"/></td>
							  <td></td>
							  <td></td>
							  <td></td>
							</tr>
							<tr>
							  <td>服务套餐名称&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s2:textfield name="service.serviceName" size="10" maxlength="10" readonly="true"/></td>
							  <td></td>
							  <td></td>
							  <td></td>
							</tr>
							<tr>
							  <td>服务天数&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s2:textfield name="service.serviceDay" size="10" maxlength="10" readonly="true"/></td>
							  <td>
							  </td>
							  <td></td>
							  <td></td>
